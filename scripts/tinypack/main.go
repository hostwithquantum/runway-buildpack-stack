...
func main() {
	...
	metadata = strings.ReplaceAll(metadata, "\t", "")
	//[detector] ERROR: failed to initialize detector: reading order: failed to read order file: open /cnb/order.toml: no such file or directory
